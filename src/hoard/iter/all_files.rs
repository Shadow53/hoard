        ...
        let root_paths = match hoard {
            Hoard::Anonymous(pile) => {
                ...
                match path {
                    ...
                    Some(system_prefix) => {
                        vec![RootPathItem {
                            hoard_file: CachedHoardItem::new(
                                PileName::anonymous(),
                                hoard_name_root,
                                system_prefix,
                                RelativePath::none(),
        ...
        loop {
            ...
            if let Some(system_entries) = self.system_entries.as_mut() {
                for entry in system_entries {
                    ...
                    let new_item = CachedHoardItem::new(
                            ...
                            RootPathItem { hoard_file, filters: current_root.filters.clone() }
                        });

                    let new_item = super::propagate_error!(new_item);
